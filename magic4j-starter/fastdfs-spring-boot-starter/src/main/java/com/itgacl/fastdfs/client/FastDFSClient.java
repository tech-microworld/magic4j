package com.itgacl.fastdfs.client;

import com.itgacl.fastdfs.bean.FastDFSFile;
import com.itgacl.fastdfs.bean.FastDFSUploadResult;
import com.itgacl.fastdfs.exception.ERRORS;
import com.itgacl.fastdfs.exception.FastDFSException;
import com.itgacl.fastdfs.util.FileUtil;
import com.itgacl.fastdfs.util.MD5Util;
...
public class FastDFSClient {
    ...
    public String uploadFile(File file) throws FastDFSException {
        try {
            ...
            byte[] fileContent = FileUtil.file2ByteArray(file);
    ...
    public List<FastDFSUploadResult> uploadFile(Map<String, InputStream> inputStreamMap) throws FastDFSException {
        ...
        try {
            ...
            for(Map.Entry<String,InputStream> entry:inputStreamMap.entrySet()){
                ...
                byte[] fileContent = FileUtil.input2ByteArray(inputStream);
                ...
                try {
                    ...
                    String fileMd5 = MD5Util.getBytesMD5(fileContent);
