 ...
 */
package com.itgacl.magic4j.libcommon.component.cache.caffeine;
...
@Configuration
@ConditionalOnProperty(prefix = "magic4j.cache", value = "type", havingValue = "caffeine", matchIfMissing = true)
...
public class CaffeineCacheConfig {
    ...
    public CacheManager cacheManager() {
        log.debug("Initializing cache: {}", Arrays.toString(RemovalCause.values()));
